...
export default function HeroSection() {
  return (
    <section className="w-full min-h-screen flex flex-col lg:flex-row">
      <div className="w-full lg:w-1/2 bg-foco-light-blue relative overflow-hidden py-6">
        ...
        {/* Hero Animals */}
        <div className="relative bottom-0 lg:absolute lg:bottom-[250px] w-full flex justify-center items-end gap-2 sm:gap-4 z-10 px-4 sm:px-8">
          {[
            ...
            <div
              ...
              className={`relative ${
                animal.large
                  ? "w-[120px] h-[200px] sm:w-[140px] sm:h-[220px] md:w-[160px] md:h-[260px]"
        ...
        <div className="mt-10 lg:mt-0 absolute bottom-0 w-full bg-foco-pink flex justify-around items-center px-4 sm:px-8 py-4 sm:py-6">
          {[0, 1, 2].map((_, i) => (
      ...
      <div className="w-full lg:w-1/2 bg-foco-amber flex flex-col justify-center px-6 sm:px-12 py-12 relative">
        {/* Header Icons */}
        <div className="absolute top-4 right-4 flex items-center space-x-4 text-foco-dark text-lg sm:text-xl z-20">
          <FaUser />
          <FaShoppingCart />
          <HiMenu />
        </div>
        ...
        {/* Main Content */}
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foco-dark leading-tight max-w-2xl">
          Quality pet food{" "}
          <span className="hero-text-outlined font-dotted">ensures</span> pet well-being
        </h1>

        <p className="mt-4 text-sm sm:text-base text-foco-dark/90 max-w-lg">
        ...
        <button className="mt-6 inline-flex items-center bg-foco-dark text-white text-base sm:text-lg font-medium rounded-full px-5 sm:px-6 py-2.5 sm:py-3 max-w-max hover:opacity-90 transition">
