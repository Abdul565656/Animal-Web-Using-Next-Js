          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            {latestProducts.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-white rounded-xl shadow-lg hover:shadow-xl group flex flex-col overflow-hidden transition-all duration-300 ease-out hover:-translate-y-0.5"
                >
